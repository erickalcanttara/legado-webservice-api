...
public class BuscarTodosLimitesTest {
    ...
    @DisplayName("Testes Regras de Negócio - Mais de um cartão")
    @ParameterizedTest
    @CsvFileSource(resources = "/massaDeTestes/buscarTodosLimites/MassaDeTestes-MaisDeUmCartao.csv", numLinesToSkip = 1, delimiter = ';')
    public void BuscarTodosLimitesTest_MAIS_DE_UM_CARTAO(String ReferenceTest, String CPF, String id_conta) throws IOException {
